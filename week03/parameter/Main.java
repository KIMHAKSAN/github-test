...
public class Main {
    public static void main(String[] args) {
        ...
        // 매서드 실행 완료 후 전달할 매개값으로 지정된 type 값 확인
        System.out.println("type = " + type);
        // 메서드 실행 완료 후 반환된 매개값으로 지정된 type 값 확인
        ...
        // 전달할 매개값으로 지정된 tire 인스턴스의 주소값이 전달되었기 때문에 호출한 메서드에 의해 값이 변경됨

        // 메서드 실행 완료 후, 반환된 car 인스턴스의 tire 객체 값이 반환되어 저장된 참조형 변수 carInstance가 생성
